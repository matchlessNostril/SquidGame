  ...
  <div id="bgcloud">
    ...
    <v-container fill-height fluid>
      <v-col justify="center" align="center">
        ...
        <p id="result">
          {{ result }} <br /><span id="accent">SCORE: {{ score }}</span>
        </p>
...
export default {
  data() {
    return {
      ...
      life: 5,
      dead: 0,
      lifeurl: require("../../assets/images/game/muk-chi-pa/dalgona.png"),
      deadurl: require("../../assets/images/game/muk-chi-pa/brokendalgona.png"),
    };
  },
  methods: {
    changeHand() {
