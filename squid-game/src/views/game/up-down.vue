...
export default {
  data() {
    return {
      ...
      imgurl: require("../../assets/images/game/up-down/life.jpg"),
      logo: require("../../assets/images/game/up-down/logo.jpg"),
    };
  },
  methods: {
    startTimer: function () {
...
<style scoped src="../../assets/css/game/up-down.css"></style>
